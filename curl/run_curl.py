...
def main():
    ...
    parser.add_argument('--env_kwargs_observation_mode', default='img_depth', type=str)  # Should be in ['key_point', 'cam_rgb', 'point_cloud', 'img_depth']
    parser.add_argument('--env_kwargs_num_variations', default=12, type=int)

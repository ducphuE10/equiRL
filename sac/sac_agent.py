...
from sac.encoder import make_encoder
...
class SacAgent(object):
    def __init__(
      ...
      curl_latent_dim=128
        ...
        #-------------------------EQUISAC-------------------------
        # self.actor = EquivariantSACActorSO2((3, 128, 128), action_shape[0], n_hidden=hidden_dim).to(device)
        # self.critic = EquivariantSACCriticSO2((3, 128, 128), action_shape[0], n_hidden=hidden_dim).to(device)
        # self.critic_target = EquivariantSACCriticSO2((3, 128, 128), action_shape[0], n_hidden=hidden_dim).to(device)
        # self.critic_target.load_state_dict(self.critic.state_dict())
        #-------------------------EQUISAC-------------------------
